...
import EditUnitCategoryModal from "../../modals/Settings/UnitCategoryModal/EditUnitCategoryModal";
import DeleteUnitCategoryConfirmationModal from "../../modals/Settings/UnitCategoryModal/DeleteUnitCategoryConfirmationModal";
import AddUnitCategoryModal from "../../modals/Settings/UnitCategoryModal/AddUnitCategoryModal";
...
const UnitCategories = () => {
  ...
  const {
    data: unitCategories, // Renamed 'data' to 'unitCategories' for clarity
    totalCount,
    isLoading,
    error,
    mutate,
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      if (unitCategories.length === 1 && currentPage > 1) {
      ...
      console.error("Failed to delete unit category:", err);
    ...
    <>
        ...
        >
          <div className="relative flex-grow w-full">
            ...
            <input
              ...
              placeholder="Search by unit category..."
      ...
      {selectedCategory && (
        <>
          ...
          />
          <DeleteUnitCategoryConfirmationModal
            isOpen={isDeleteModalOpen}
            onClose={() => setIsDeleteModalOpen(false)}
            onConfirm={handleConfirmDelete}
            isDeleting={isProcessing}
            itemName={selectedCategory.unit_category}
          />
        </>
      )}
    </>
