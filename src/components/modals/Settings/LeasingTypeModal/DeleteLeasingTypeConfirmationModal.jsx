//src/components/modals/LeasingTypeModal/DeleteLeasingTypeConfirmationModal.jsx
...
const DeleteLeasingTypeConfirmationModal = ({
  isOpen,
  onClose,
  onConfirm,
  isDeleting,
...
export default DeleteLeasingTypeConfirmationModal;
